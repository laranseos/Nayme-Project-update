      ...
      <div className="w-full sm:w-3/5 flex flex-col border shadow-xl ">
        ...
        <form className="flex justify-center">
          <div className="sm:w-4/5">
            <div className="grid gap-8 mt-6 mb-6">
              <div>
                <input 
                  type="Uzername" 
                  id="company" 
                  ...
                  block w-full p-2.5" placeholder="Username" required>
                </input>
              </div>
              <div>
                <input 
            ...
            >Login</button>
            <div> 
              <p className="mt-2 text-xs sm:text-sm mb-20 float-right text-gray-300">Not registered yet?<a href='/signup' className="text-black underline">Create an Account</a></p>
            </div>
          </div>
        </form>
      </div>
